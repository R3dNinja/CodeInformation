...
namespace ManageCodeInformation
{
    class CreateRibbonTab
    {
        ...
        const string Message = "Update Code Information from Word Document.";
        ...
        private static BitmapImage NewBitmapImage(Assembly a, string imageName)
        {
            ...
            Stream s = Assembly.GetExecutingAssembly().GetManifestResourceStream("ManageCodeInformation.Graphics." + imageName);
        ...
        public void tabAndButtons(UIControlledApplication UIConApp)
        {
            ...
            d.ToolTip = "Export and Update Code Information";
            d.Image = NewBitmapImage(exe, "CodeInformation16.png");
            d.LargeImage = NewBitmapImage(exe, "CodeInformation32.png");
